...
.\build.ps1 -Name icons-arcticons -Version 1.2.3
```
...
```
<project>/.config/icons-arcticons/<packaging>.build-host
$HOME/.config/icons-arcticons/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-arcticons
```
